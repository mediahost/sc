...
class GuestSettingsStorage extends Object
{
	...
	public function save($userId)
	{
		...
		if ($userEntity) {
			if (isset($this->section->page) && $this->section->page && $userEntity->pageConfigSettings instanceof PageConfigSettings) {
			...
			if (isset($this->section->design) && $this->section->design && $userEntity->pageDesignSettings instanceof PageDesignSettings) {
